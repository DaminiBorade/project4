...
public class RoleModel {
	...
	// private Loader log =Logger.getLogger(RoleModel.class);
	/**
	...
	public int add(RoleBean bean) throws ApplicationException, DuplicateException, RecordNotFoundException {
	...
	public void delete(RoleBean bean) throws ApplicationException {
		...
		System.out.println(bean.getId() + "inside model >>>>>>");
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false);// Begin transaction
