...
public final class JDBCDataSource {
	...
	public static JDBCDataSource getInstance() {
		if (datasource == null) {
			...
			ResourceBundle rb = ResourceBundle.getBundle("in.co.rays.project4.bundle.System");
			 ...
			 * datasource.cpds.setInitialPoolSize(new Integer((String)
			 * PropertyReader.getValue("initialPoolSize")));
			 * datasource.cpds.setAcquireIncrement(new Integer((String)
			 * PropertyReader.getValue("acquireIncrement")));
			 * datasource.cpds.setMaxPoolSize(new Integer((String)
			 * PropertyReader.getValue("maxPoolSize")));
			 * datasource.cpds.setMaxIdleTime(DataUtility.getInt(PropertyReader.
			 * getValue("timeout"))); datasource.cpds.setMinPoolSize(new
			 * Integer((String) PropertyReader.getValue("minPoolSize")));
			 */
