...
<jsp:useBean id="colbean" class="in.co.rays.project4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="in.co.rays.project4.bean.CourseBean" scope="request"></jsp:useBean>
...
<form action="<%=ORSView.FACULTY_LIST_CTL %>" method="post">
	...
	<table width ="100%" align="center">
		...
		<label>College Name :</label>
		 <%=HTMLUtility.getList("collegeid", String.valueOf(bean.getCollege_id()), clist) %>
                   	
		&nbsp;
		<label>Course Name :</label>
		<%=HTMLUtility.getList("courseid", String.valueOf(bean.getCourse_id()), colist) %>		
		&nbsp;
	...
	<tr>
		...
		<td align="center"><%=bean.getFrist_Name() %></td>
		<td align="center"><%=bean.getLast_Name() %></td>
		<td align="center"><%=bean.getEmail_id() %></td>
		<td align="center"><%=bean.getCollege_Name() %></td>
		<td align="center"><%=bean.getCousre_Name() %></td>
		<td align="center"><%=bean.getSubject_Name() %></td>
		<td align="center"><%=bean.getDOJ() %></td>
		<td align="center"><%=bean.getMobile_No() %></td>
