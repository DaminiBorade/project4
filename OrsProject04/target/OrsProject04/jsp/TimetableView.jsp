...
<center>
	...
	<input type="hidden" name="modifiedby" value="<%=DataUtility.getTimestamp(bean.getModified_Date_Time())%>">
...
<table>
 ...
 <tr><th style="padding: 3px"></th></tr>  
	...
	<td> <input type="text" readonly="readonly" id="datepiker" size="20" placeholder="Select Date" name="ExDate" value="<%=DataUtility.getDateString(bean.getExam_Date()) %>">
