...
<body>
   ...
   <form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="POST">
    ...
    <%
    List clist=(List)request.getAttribute("rollNo");
       ...
       <h3><font color="green"><%=ServletUtility.getSuccessMessage(request)%></font></h3>
            ...
            <table width="100%" align="center">
                <tr>
                    ...
                    --%>
                    <%=HTMLUtility.getList("rollNo",ServletUtility.getParameter("rollNo", request),clist) %>
                     &nbsp;
            ...
            <table width="100%">
				...
				<td align="right"><input type="submit" name="operation" value="<%=MarksheetListCtl.OP_NEXT%>"></td>
                    ...
                    <td align="right"><input type="submit"  name="operation" value="<%=MarksheetListCtl.OP_NEXT%>" <%=(list.size()<pageSize)?"disabled":"" %>> </td>
