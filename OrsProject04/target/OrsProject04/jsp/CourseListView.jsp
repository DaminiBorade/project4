...
<jsp:useBean id="bean" class="in.co.rays.project4.bean.CourseBean" scope="request" ></jsp:useBean>
  ...
  <%@include file="Header.jsp"%>
    ...
    <%
		List<CourseBean> l = (List<CourseBean>)request.getAttribute("clist"); 
            ...
            <table width="100%" align="center">
                <tr>
                 ...
                 <label> Course Name :</label> 
                 	<%=HTMLUtility.getList("cname", String.valueOf(bean.getId()), l) %>
                 <!--  	<input type="text" name="cname" placeholder="Enter Course Name" Size= "25" value="<%=DataUtility.getStringData(bean.getCourse_Name()) %>">
					--> &nbsp;
